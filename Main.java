...
public class Main {
    ...
    public static final int PTS_PER_ANSWER = 10, TOTAL_PTS_POSSIBLE = PTS_PER_ANSWER * STATEMENTS.length,
        MAX = PersonIdentity.DEFAULT_PRIVILEGE + TOTAL_PTS_POSSIBLE,
        MIN = PersonIdentity.DEFAULT_PRIVILEGE - TOTAL_PTS_POSSIBLE,
    ...
    public static void main(String[] args) {
        ...
        PersonIdentity p1 = new PersonIdentity("Amira", "I am a Syrian refugee.", 40, "she/her", "Syrian descent");
        PersonIdentity p2 = new PersonIdentity("D'Andra", "I am an African-American trans woman.", -20, "she/her", "African-American");
        PersonIdentity p3 = new PersonIdentity("Jennifer", "I am a New Yorker", 140, "she/her", "White-American");
        PersonIdentity p4 = new PersonIdentity("Pete", "I am a guy from Pennsylvania", 200, "he/him", "Caucasian");
        PersonIdentity self = new PersonIdentity();
        PersonIdentity[] people = { p1, p2, p3, p4, self };
        boolean done = false;
        int input;
        ...
        do {
            ...
            System.out.println("2. Check my estimate. (Defaults to " + PersonIdentity.DEFAULT_PRIVILEGE + " if questionnaire has not been taken.)");
            ...
            switch (input) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Comparing your privilege with others...\n");

                    Arrays.sort(people);

                    System.out.println("Here is how you compare to others based on privilege estimate:\n");
    ...
    public static void fillInfo(PersonIdentity person) {
        // sets default privilege prior to questionnaire to 100
        String name, story, pronouns, background;

        System.out.println("What is your name? ");
        name = keyboard.nextLine();

        System.out.println("\nHello " + name + ", please write a small self-identifying statement about yourself "
                + "and your background and identity. This can include nationality, ethnicity, sexuality, gender expression, etc.");
        ...
        System.out.println("Can you elaborate on your background or identity? (optional)");
    ...
    public static int doPrivilegeQuestionnaire() {
        boolean isValid;
        int choice, privilegeEstimate = PersonIdentity.DEFAULT_PRIVILEGE;
